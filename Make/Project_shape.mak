...
CPPFLAGSV0   = -ansi -pedantic-errors -Wall -fPIC -Wold-style-cast $(CFG_FLAGS) $(PROJ_CFLAGS)
else
CFLAGS     = 
CPPFLAGS   =
endif

CPPFLAGS   = $(CPPFLAGSV0) -std=c++$(VER)
#ifeq ($(VER), c++98)
#CPPFLAGS   = $(CPPFLAGSV0) -std=c++98
#else
#CPPFLAGS   = $(CPPFLAGSV0) -std=c++11
#endif
...
all: $(PROJ_DEPENDS) $(BIN_DIR)/$(PROJ_OUT) $(PROJ_OUT)
	@echo All targets made

#Creates link
ifeq ($(LINK), 0)
$(PROJ_OUT):
	ln -s $(BIN_DIR)/$(PROJ_OUT)
LINK = 1
else
$(PROJ_OUT):
endif
...
$(BIN_DIR)/$(basename $(PROJ_OUT)).out: $(PROJ_OBJS) $(PROJ_OTHER_OBJS)
	@echo Creating application $(@F)
	$(ECHO_FLAG)$(LD) $(PROJ_OBJS) $(PROJ_OTHER_OBJS) -Wl,-rpath=$(PROJ_LIBS_DIR) $(LDFLAGS) $(PROJ_LIBS:%=%) -o $(@)
